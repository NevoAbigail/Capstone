...
Expected Results: Survey users on their opinions of the visual appeal of the device; see \nameref{User Testing}. A majority of surveyed users should deem the visual appeal satisfactory.
...
\begin{enumerate}
    ...
    \item Do you like the visual appeal of the App graphical user interface and the SmartLock physical's features? 
