...
\begin{enumerate}
  ...
  Elsa: The VnVPlan was different than the actual VnV because several of the tests were initially hoped to be broader, however the group decided to utilize our time more effectively by making the tests more concise but still useful. This is because we realized we could not conduct 100 user test trials to be mindful of our test subject's time, but we did not anticipate this ahead of time.
\end{enumerate}
