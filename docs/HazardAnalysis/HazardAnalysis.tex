...
%TO DO: add references to these reqs that are already in SRS, and add appropriate references in FMEA
%Battery life: NFR13, NFR14 
%Water and weather proofing: NFR6, NFR7 
%Portability and size: FR10 
%Other: FR9 (Lock must only be able to be disengaged by intended user(s).  
