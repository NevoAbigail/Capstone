...
\item{FR11: Battery percentage must be shown on the phone app. \\}
Type: Manual 
...
\item{FR12: Location (coordinates) of bike must be shown on the app as BikePosition. \\}
Type: Manual 
...
\subsubsection{Physical Lock}

\begin{enumerate}

\item{FR13: Battery must output enough power to engage the lock. \\}
Type: Manual 
...
\begin{enumerate}
\item{NFR4: The design must be visually appealing. \\}
Type: Manual 
...
\item{NFR5: The lock must not impede normal bike functions. \\}
Type: Manual 
...
\item{NFR6: The lock must be waterproofed to withstand normal rainfall. And NFR7:  The lock must be waterproofed to withstand normal splashing while riding. \\}
...
\item{NFR8: Accuracy of bike lock status must be above 95\%. \\}
Type: Manual 
