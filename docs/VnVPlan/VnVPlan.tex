...
\item{EngageLockStatus: 

FR2: When the lock is engaged, change lock status to engaged. } 
...
How the test will be performed: The bike lock will be engaged.  
 ...
 \item{DisengageLockStatus: 
 
 FR3: When the lock is disengaged, change lock status to disengaged. } 
...
\item{LockStatusAccuracy

NFR6: Accuracy of bike lock status must be above 95\%. }
...
\begin{tabular}{| p{0.3\textwidth} | p{0.4\textwidth} | p{0.4\textwidth} |}
 ...
 DisengageLock & FR1 &  \\ 
  \hline
 EngageLockStatus & FR2 &  \\
  \hline
 DisengageLockStatus & FR3 &  \\  
  \hline
 LockLocation & FR4 &  \\ 
  \hline
...
Note: NFR 14-17 and 19 were deemed out of scope on the SRS, and thus are not present in this Verification and Validation Plan. 
