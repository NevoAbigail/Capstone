...
Stephen: To aquire critical thinking skill we will need to think ourside the box and ask others their thoughts so that we can gain multiple opinions and a different way of thinking. To aquire the technical knowledge about our device, many hours of research as well as talking with indurstry professionals well be needed.
